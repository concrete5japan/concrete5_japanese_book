...
<?php	 } elseif ($vPlayer == 1) { ?>
	...
	<div id="youtube<?php	echo  $bID; ?>" class="youtubeBlock">
		<iframe class="youtube-player" width="<?php	echo  $vWidth; ?>" height="<?php	echo  $vHeight; ?>" src="http://www.youtube.com/embed/<?php	echo  $videoID; ?>" frameborder="0" allowfullscreen></iframe>
	</div>
...
<?php	 } else { ?>
	...
	flashvars = {};
	swfobject.embedSWF('http://www.youtube.com/v/<?php	echo  $videoID; ?>&amp;hl=en', 'youtube<?php	echo  $bID; ?>_video', '<?php	echo  $vWidth; ?>', '<?php	echo  $vHeight; ?>', '8.0.0', false, flashvars, params);
	//]]>
	</script>
