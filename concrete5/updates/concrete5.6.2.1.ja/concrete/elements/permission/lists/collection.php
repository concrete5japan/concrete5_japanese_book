...
ccm_permissionLaunchDialog = function(link) {
	jQuery.fn.dialog.open({
		...
		href: '<?php	echo REL_DIR_FILES_TOOLS_REQUIRED?>/edit_collection_popup?cID=<?php	echo $c->getCollectionID()?>&ctask=set_advanced_permissions&pkID=' + $(link).attr('data-pkID') + '&paID=' + $(link).attr('data-paID'),
		modal: false,
		width: 500,
		height: 380
	});		
