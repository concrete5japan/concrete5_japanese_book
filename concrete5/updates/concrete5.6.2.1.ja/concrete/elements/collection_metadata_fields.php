...
<div id="ccm-attributes-column" class="span3">
	...
	<?php	 foreach($sets as $as) { ?>
		<li class="item-select-list-header ccm-attribute-available"><span><?php	echo tc('AttributeSetName', $as->getAttributeSetName())?></span></li>
		<?php	 
