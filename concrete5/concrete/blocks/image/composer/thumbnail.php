...
ccm_triggerSelectFileComplete = function(fID, af) { 
	...
	ccm_alGetFileData(fID, function(data) {
		...
		td.append('<a href="<?php	echo $dialogurl?>?bID=' + af.substring(12) + '&width=' + tw + '&height=' + th + '&fID=' + fID + '" class="dialog-launch" dialog-modal="false" dialog-width="95%" dialog-height="460" dialog-title="Crop Image" class="dialog-launch" id="cropper-dialog-' + af.substring(12) + '"><?php	echo t('Crop + Upload Image')?></a>');
